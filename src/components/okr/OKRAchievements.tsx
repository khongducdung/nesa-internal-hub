...
export function OKRAchievements() {
  ...
  return (
    <div className="space-y-8">
      {/* Header Stats with blue gradient and decorative circles */}
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className={`text-xs mb-3 ${achievement.earned ? 'text-gray-600' : 'text-gray-400'}`}>
                      {achievement.description}
                    </p>
                    
                    {/* Rarity Badge */}
                    <Badge className={`${rarityInfo.color} text-xs mb-3`}>
