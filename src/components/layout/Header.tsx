...
export function Header({
  ...
  return <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-30">
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="flex-1 max-w-md mx-6">
          <div className="relative">
            ...
            <Input placeholder="Tìm kiếm..." className="pl-10 pr-4 py-2 h-9 w-full bg-gray-50 border-gray-200 rounded-full focus:ring-primary focus:border-primary placeholder:text-gray-400 text-sm" />
          </div>
        </div>
